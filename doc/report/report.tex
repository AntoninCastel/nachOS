...
Pour synchroniser son utilisation de plusieurs threads, l'utilisateur dispose de sémaphores. Pour cela, nous avons crée au niveau noyau un tableau de \texttt{Semaphore*} 
